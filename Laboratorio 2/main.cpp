...
int main(){
    ...
    int profundidad;
    int n;
    cout << "Ingresa el nivel de profundidad: ";
    cin >> profundidad;
    cout<< " 0 -> Inicia IA"<<endl;
    cout<< " 1 -> Inicia Jugador"<<endl;
    cout<< " --> ";
    cin>> n;
    
    checkers game(n, profundidad);
    ...
    while (true){
        ...
        if (option == 1){
            ...
            cout << "Ingrese las coordenas X e Y de la Ficha que quieras mover" << endl;
            cin >> token_x_position; cin >> token_y_position; cout << endl << endl;
            cout << "Ingrese las coordenas X e Y del destino de la Ficha" << endl;
